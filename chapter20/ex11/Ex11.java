...
public class Ex11 implements ProcessFiles.Strategy {
    ...
    public void process(File cFile) {
        try {
            ...
            if(!cName.contains("."))
                return; // Ignore packaged classes
...
// Synthesized default constructor; OK
        ...
        for(Method m : testMethods) {
            ...
            if(testNotes.containsKey(m))
                System.out.println(" : " + testNotes.get(m) + " ");
            try {
